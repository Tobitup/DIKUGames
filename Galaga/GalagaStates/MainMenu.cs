...
public class MainMenu : IGameState {
    ...
    /// <summary> Initializes the Main Menu of game </summary>
    ...
    /// <summary> Handles KeyEvents for MainMenu </summary>
    /// <param = action> The action the user can do of type KeybaordAction </param>
    /// <param = key> The key a user can press </param>
    /// <returns> Void </returns> 
